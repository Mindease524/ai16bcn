...
export type ForecastMarket = {
  address: "DQ31XNvikuu2gaQaxwSo2BpAkWiTWwTc6iEJcvjNLLBy";
  metadata: {
    name: "forecastMarket";
    version: "0.1.0";
    spec: "0.1.0";
  ...
  instructions: [
    {
      name: "addAnswerKeys";
      discriminator: [89, 115, 155, 223, 0, 19, 17, 59];
      accounts: [
        {
          name: "owner";
          writable: true;
    ...
    {
      name: "adjournMarket";
      discriminator: [122, 223, 248, 29, 26, 4, 248, 39];
      accounts: [
        {
          name: "owner";
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [98, 101, 116, 116, 105, 110, 103];
              },
              {
                kind: "account";
                path: "voter";
    ...
    {
      name: "draftMarket";
      discriminator: [251, 196, 130, 72, 251, 64, 188, 39];
      accounts: [
        {
          name: "owner";
          writable: true;
    ...
    {
      name: "finishMarket";
      discriminator: [200, 216, 58, 2, 224, 204, 151, 26];
      accounts: [
        {
          name: "owner";
          writable: true;
    ...
    {
      name: "retrieveTokens";
      discriminator: [208, 194, 68, 55, 183, 22, 93, 135];
      accounts: [
        {
          name: "owner";
          writable: true;
    ...
    {
      name: "setAccount";
      discriminator: [100, 58, 16, 200, 83, 84, 162, 203];
      accounts: [
        {
          name: "owner";
          writable: true;
    ...
    {
      name: "successMarket";
      discriminator: [252, 13, 1, 40, 160, 91, 131, 212];
      accounts: [
        {
          name: "owner";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [35, 111, 215, 56, 135, 228, 232, 50];
      accounts: [
        {
          name: "owner";
          writable: true;
  ...
  accounts: [
    {
      name: "answerAccount";
      discriminator: [75, 175, 139, 96, 119, 135, 123, 71];
    },
    {
      name: "bettingAccount";
      discriminator: [128, 101, 147, 11, 71, 96, 22, 160];
    },
    {
      name: "configAccount";
    ...
    {
      name: "marketAccount";
      discriminator: [201, 78, 187, 225, 240, 198, 201, 251];
    }
  ];
  events: [
    {
      name: "answerAdded";
      discriminator: [82, 95, 97, 36, 223, 127, 175, 26];
    },
    {
      name: "betPlaced";
    ...
    },
    {
      ...
      discriminator: [255, 9, 83, 139, 244, 130, 217, 61];
    },
    {
      name: "marketApproved";
      discriminator: [213, 222, 68, 97, 16, 1, 31, 38];
    },
    {
      name: "marketDrafted";
      discriminator: [165, 166, 240, 170, 76, 56, 133, 177];
    },
    {
      name: "marketFinished";
      discriminator: [55, 252, 141, 64, 190, 178, 104, 34];
    },
    {
      name: "marketSuccess";
      discriminator: [28, 146, 105, 87, 226, 249, 99, 105];
    },
    {
      name: "rewardClaimed";
    ...
    {
      name: "tokenClaimed";
      discriminator: [49, 144, 233, 63, 84, 154, 232, 26];
    }
  ];
  errors: [
    {
